...
import {
  ...
  Transfer
} from "../generated/SugarPretzel/SugarPretzel"
...
export function handleApproval(event: Approval): void {
  ...
  // - contract.balanceOf(...)
  // - contract.baseURI(...)
  // - contract.currentConditions(...)
  // - contract.getApproved(...)
  // - contract.getOracleAddress(...)
  // - contract.hasMintedGasless(...)
  // - contract.hausDerKunstLocation(...)
  // - contract.isApprovedForAll(...)
  // - contract.isTrustedForwarder(...)
  // - contract.lastUpdate(...)
  // - contract.locationConditionsJobId(...)
  // - contract.locationInfo(...)
  // - contract.name(...)
  // - contract.owner(...)
  // - contract.ownerOf(...)
  // - contract.precipitationConversionConstant(...)
  // - contract.pretzelData(...)
  // - contract.supportsInterface(...)
  // - contract.symbol(...)
  // - contract.temperatureConversionConstant(...)
  // - contract.tokenURI(...)
  // - contract.totalSupply(...)
  // - contract.updateFrequency(...)
}
